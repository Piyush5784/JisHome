    ...
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        ...
        <p className="text-base text-gray-700 md:text-lg">
          Our team of interior designers brings creativity and innovation to
          every project, ensuring that each space is both functional and
        ...
        <div>
          <div className="relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
            ...
            <div className="absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-black bg-opacity-75 opacity-0 hover:opacity-100">
              ...
              <p className="mb-4 text-xs tracking-wide text-gray-400">
                Expert in making a next level designs.
              </p>
              <div className="flex items-center justify-center space-x-3">
                <a
                  href="/"
        ...
        <div>
          <div className="relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
            ...
            <div className="absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-black bg-opacity-75 opacity-0 hover:opacity-100">
              ...
              <p className="mb-4 text-xs tracking-wide text-gray-400">
                Dedicated to leveraging technology to create innovative and
                efficient solutions.
              </p>
              <div className="flex items-center justify-center space-x-3">
                <a
        ...
        <div>
          <div className="relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
            ...
            <div className="absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-black bg-opacity-75 opacity-0 hover:opacity-100">
              ...
              <p className="mb-4 text-xs tracking-wide text-gray-400">
                Committed to fostering a positive and productive work
                environment.
              </p>
              <div className="flex items-center justify-center space-x-3">
                <a
        ...
        <div>
          <div className="relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
            ...
            <div className="absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-black bg-opacity-75 opacity-0 hover:opacity-100">
              ...
              <p className="mb-4 text-xs tracking-wide text-gray-400">
                Dedicated to creating stunning and functional interior spaces.
              </p>
              <div className="flex items-center justify-center space-x-3">
                <a
                  href="/"
        ...
        <div>
          <div className="relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
            ...
            <div className="absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-black bg-opacity-75 opacity-0 hover:opacity-100">
              ...
              <p className="mb-4 text-xs tracking-wide text-gray-400">
                Passionate about designing spaces that are both beautiful and
                functional.
              </p>
              <div className="flex items-center justify-center space-x-3">
                <a
